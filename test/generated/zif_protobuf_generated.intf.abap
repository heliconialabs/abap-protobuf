...
TYPES: BEGIN OF BaseCommand,
         ...
         redeliverUnacknowledgedMessages TYPE CommandRedeliverUnacONw3qa,
         partitionMetadata TYPE CommandPartitionedTomVmlsw,
         partitionMetadataResponse TYPE CommandPartitionedToJik1cm,
         ...
         consumerStatsResponse TYPE CommandConsumerStatsLMgarI,
         reachedEndOfTopic TYPE CommandReachedEndOfTopic,
         seek TYPE CommandSeek,
         getLastMessageId TYPE CommandGetLastMessageId,
         getLastMessageIdResponse TYPE CommandGetLastMessag2udLG8,
         active_consumer_change TYPE CommandActiveConsumetry0NX,
         getTopicsOfNamespace TYPE CommandGetTopicsOfNaW5sMTo,
         getTopicsOfNamespaceResponse TYPE CommandGetTopicsOfNa2Zpv1F,
         ...
         getOrCreateSchemaResponse TYPE CommandGetOrCreateScVKbTgH,
         newTxn TYPE CommandNewTxn,
         newTxnResponse TYPE CommandNewTxnResponse,
         addPartitionToTxn TYPE CommandAddPartitionToTxn,
         addPartitionToTxnResponse TYPE CommandAddPartitionTafUHa4,
         addSubscriptionToTxn TYPE CommandAddSubscriptisyuJS0,
         addSubscriptionToTxnResponse TYPE CommandAddSubscripti6CDt1m,
         endTxn TYPE CommandEndTxn,
         endTxnResponse TYPE CommandEndTxnResponse,
         endTxnOnPartition TYPE CommandEndTxnOnPartition,
         endTxnOnPartitionResponse TYPE CommandEndTxnOnPartiOOlMQv,
         endTxnOnSubscription TYPE CommandEndTxnOnSubscqx6OWu,
         endTxnOnSubscriptionResponse TYPE CommandEndTxnOnSubscVUpsoc,
         tcClientConnectRequest TYPE CommandTcClientConneWIoTIu,
         tcClientConnectResponse TYPE CommandTcClientConneTuQpSf,
         watchTopicList TYPE CommandWatchTopicList,
         watchTopicListSuccess TYPE CommandWatchTopicLisUXqMY2,
